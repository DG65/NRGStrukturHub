<?php
/**
 * check-standalone.php — Prüft die Eigenständigkeit dieses Moduls (Katasteramt, vormals StrukturHub).
 *
...
// STRUKT ist der EIGENE Präfix dieses Repos und gehört daher NICHT in die
// Liste — sonst meldet das Skript die eigenen Funktionen als ungeschützte
// Fremdaufrufe.
const FOREIGN_PREFIXES = ['IHUB', 'IHUBD', 'IHUBNRG', 'IHUBMON', 'IHUBTILE', 'MHUB', 'MHUBV', 'CHUB', 'MIGHUB', 'PVF', 'LFC', 'HEISHA', 'WPHUB', 'SGW', 'SBH', 'TIBBERGR', 'TESSIE', 'EMS', 'NRGDASH', 'MODBUS', 'GWET'];
